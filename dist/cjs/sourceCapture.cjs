...
exports.captureSourceFromStack = captureSourceFromStack;
 ...
 */
function captureSourceFromStack(stack) {
    if (!stack)
        return undefined;
...
//# sourceMappingURL=sourceCapture.js.map